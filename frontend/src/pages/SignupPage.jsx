...
function SignupPage() {
  ...
  return (
    <section className="max-w-md mx-auto px-4 py-8 sm:py-10">
      <Seo title="Customer Signup | Puja Samriddhi" description="Create your customer Puja Samriddhi account." />
      <h1 className="text-2xl sm:text-3xl font-semibold text-[#333333]">Customer Signup</h1>
      <form onSubmit={handleSubmit} className="mt-4 space-y-3 bg-white border border-[#FFE0A3] rounded-xl p-4 sm:p-5">
        ...
        <button className="w-full py-2 rounded-lg bg-linear-to-r from-[#D84315] to-[#FF6F00] text-white">Signup</button>
      </form>
      <p className="text-sm mt-3 wrap-break-word">Already have an account? <Link to="/login" className="text-[#FF6F00]">Login</Link></p>
