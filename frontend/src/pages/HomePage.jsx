    ...
    <>
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-14 sm:py-24 text-white">
          <div className="max-w-4xl rounded-3xl border border-white/20 bg-white/10 backdrop-blur-sm p-6 sm:p-8 animate-fade-up">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                to="/services"
                className="inline-block w-full sm:w-auto text-center px-5 sm:px-6 py-3 rounded-xl bg-linear-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 shadow-md text-sm sm:text-base font-medium"
              >
                Book a Puja
              </Link>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10 sm:py-12">
        <div className="flex items-end justify-between gap-4 animate-fade-up" style={{ animationDelay: '0.1s' }}>
          <h2 className="text-lg sm:text-2xl font-semibold">Why Families Choose PujaSamrddhi</h2>
          <Link to="/services" className="hidden sm:inline-flex text-sm font-medium text-orange-700 hover:text-orange-800">
            Explore Services →
          </Link>
        </div>

        <div className="mt-8 rounded-3xl border border-orange-100 bg-linear-to-br from-white via-orange-50/40 to-amber-50/60 p-6 sm:p-8 shadow-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <article
              className="rounded-2xl p-7 flex flex-col items-center text-center border border-orange-200 bg-linear-to-br from-orange-50 to-white shadow-sm hover:shadow-md transition-shadow animate-fade-up"
            ...
            <article
              className="rounded-2xl p-7 flex flex-col items-center text-center border border-amber-200 bg-linear-to-br from-amber-50 to-white shadow-sm hover:shadow-md transition-shadow animate-fade-up"
            ...
            <article
              className="rounded-2xl p-7 flex flex-col items-center text-center border border-yellow-200 bg-linear-to-br from-yellow-50 to-white shadow-sm hover:shadow-md transition-shadow animate-fade-up"
