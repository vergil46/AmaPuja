      ...
      <div className="max-w-6xl mx-auto px-3.5 sm:px-4 py-8 sm:py-12 grid md:grid-cols-3 gap-4 sm:gap-6">
        <div className="order-2 md:order-1 rounded-2xl border border-orange-400/25 bg-linear-to-br from-stone-900/90 to-orange-950/50 p-4 sm:p-5 animate-fade-up shadow-lg shadow-orange-900/20 backdrop-blur-sm" style={{ animationDelay: '0.08s' }}>
          ...
          <div className="mt-4 grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3 text-xs sm:text-sm">
            <a href="#" className="rounded-lg border border-stone-700/80 bg-stone-900/70 px-2.5 sm:px-3 py-2 sm:py-1.5 flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 hover:text-orange-200 hover:border-blue-400/70 hover:bg-blue-500/10 transition-colors">
            ...
            <a href="#" className="rounded-lg border border-stone-700/80 bg-stone-900/70 px-2.5 sm:px-3 py-2 sm:py-1.5 flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 hover:text-orange-200 hover:border-red-400/70 hover:bg-red-500/10 transition-colors">
            ...
            <a href="#" className="rounded-lg border border-stone-700/80 bg-stone-900/70 px-2.5 sm:px-3 py-2 sm:py-1.5 flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 hover:text-orange-200 hover:border-cyan-400/70 hover:bg-cyan-500/10 transition-colors">
        ...
        <div className="order-3 md:order-3 rounded-2xl border border-orange-400/25 bg-linear-to-br from-stone-900/90 to-amber-950/40 p-4 sm:p-5 animate-fade-up shadow-lg shadow-amber-900/20 backdrop-blur-sm" style={{ animationDelay: '0.24s' }}>
          ...
          <form onSubmit={handleSubmit} className="mt-3 sm:mt-4 space-y-2.5">
            ...
            <textarea
              ...
              required
            />
            <button className="w-full sm:w-auto px-4 py-2.5 rounded-lg bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 text-white text-sm font-medium shadow-lg shadow-orange-500/25 hover:from-orange-600 hover:via-amber-600 hover:to-rose-600 transition-all">
              Send
            </button>
